    ...
    return (
        <div className="space-y-10">
            <div className="w-11/12 mx-auto space-y-10">
                ...
                <div>
                    TechWorld is a One-Stop Tech Shop that offers Tech Enthusiasts authentic Smartphones, Gadgets & Accessories from renowned brands so they can have first-hand experience with the real thing.
                    ...
                    In TechWorld, we are continuously growing ourselves to meet the challenge of a new age and new client base. We know that client satisfaction is a never-ending journey. Also, we have a strong dedicated team that thrust us towards perfection and quality service.
                </div>
