                ...
                <div className="w-5/6 mx-auto">
                    <div className="w-2/3 gap-8 mx-auto">
                        ...
                        <div className='flex justify-center mt-5'>
                            <button onClick={handleGoogleRegister} className='w-4/5 mx-auto btn btn-outline hover:text-white border-[#0845F4] hover:bg-[#0845F4]'><FaGoogle></FaGoogle> Sign up</button>
                        </div>
                    </div>
                </div>
            </div>
